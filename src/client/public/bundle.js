...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SortApp = __webpack_require__(168);

	var _SortApp2 = _interopRequireDefault(_SortApp);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SortStore = __webpack_require__(187);

	var _SortStore2 = _interopRequireDefault(_SortStore);

	var _AlgoChoice = __webpack_require__(191);

	var _AlgoChoice2 = _interopRequireDefault(_AlgoChoice);

	var _ArrayDisplayer = __webpack_require__(192);

	var _ArrayDisplayer2 = _interopRequireDefault(_ArrayDisplayer);

	var _ValuesInput = __webpack_require__(193);
	...
	var SortApp = function (_React$Component) {
	    _inherits(SortApp, _React$Component);

	    function SortApp() {
	        _classCallCheck(this, SortApp);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(SortApp).call(this));
	    ...
	    _createClass(SortApp, [{
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_ValuesInput2.default, { values: this.state.array }),
	                _react2.default.createElement(_AlgoChoice2.default, { algo: this.state.algo }),
	                _react2.default.createElement(_ArrayDisplayer2.default, { array: this.state.array })
	            );
	        }
	    }], [{
	        key: 'getStores',
	        value: function getStores() {
	            return [_SortStore2.default];
	        }
	    }, {
	        key: 'calculateState',
	        value: function calculateState(prevState) {
	            return _SortStore2.default.getState();
	        }
	    }]);
	...
	var AppContainer = _utils.Container.create(SortApp);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SortStore = function (_ReduceStore) {
	    _inherits(SortStore, _ReduceStore);

	    function SortStore() {
	        _classCallCheck(this, SortStore);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(SortStore).apply(this, arguments));
	    }

	    _createClass(SortStore, [{
	        key: 'getInitialState',
	...
	var instance = new SortStore(_SortDispatcher2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AlgoChoice = function (_React$Component) {
	    _inherits(AlgoChoice, _React$Component);

	    function AlgoChoice(props) {
	        _classCallCheck(this, AlgoChoice);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(AlgoChoice).call(this, props));
	    }

	    _createClass(AlgoChoice, [{
	        key: 'changeAlgo',
	        value: function changeAlgo(event) {
	            (0, _SortDispatcher.dispatch)({ type: 'sort/change-algo', id: event.target.value });
	        }
	    }, {
	        key: 'sort',
	        value: function sort() {
	            (0, _SortDispatcher.dispatch)({ type: 'sort/sort' });
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	...
	AlgoChoice.propTypes = { algo: _react2.default.PropTypes.string };
	AlgoChoice.defaultProps = { algo: "bucket" };

	exports.default = AlgoChoice;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ArrayDisplayer = function (_React$Component) {
	    _inherits(ArrayDisplayer, _React$Component);

	    function ArrayDisplayer(props) {
	        _classCallCheck(this, ArrayDisplayer);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(ArrayDisplayer).call(this, props));
	    }

	    _createClass(ArrayDisplayer, [{
	        key: "render",
	        value: function render() {
	            var items = [];
	            this.props.array.forEach(function (v, i) {
	    ...
	    return ArrayDisplayer;
	}(_react2.default.Component);

	ArrayDisplayer.propTypes = { array: _react2.default.PropTypes.array };
	ArrayDisplayer.defaultProps = { array: [] };

	exports.default = ArrayDisplayer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ValuesInput = function (_React$Component) {
	    _inherits(ValuesInput, _React$Component);

	    function ValuesInput(props) {
	        _classCallCheck(this, ValuesInput);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ValuesInput).call(this, props));

	        _this.state = {
	            values: _this.props.values.join()
	        };
	        _this._onChange = _this._onChange.bind(_this);
	        _this._updateValues = _this._updateValues.bind(_this);
	        return _this;
	    }
	...
	ValuesInput.propTypes = { values: _react2.default.PropTypes.array };
